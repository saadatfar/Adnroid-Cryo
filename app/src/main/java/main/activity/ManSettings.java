...
public class ManSettings extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.men_settings);
				...
				Button back = (Button) findViewById(R.id.btn_back_men);
				Button next = (Button) findViewById(R.id.btn_next_inmen);
				
				
				
				weightText = (TextView) findViewById(R.id.txt_temp_manual);
				heightText = (TextView) findViewById(R.id.txt_time_manual);
